...
//    }
    ...
    static var defaultStore = StoredData(id: UUID().uuidString, background: UIImage(named:"img1")!.jpegData(compressionQuality: 0.8)!, display: .date, kitty: UIImage(named:"kitty1")!.jpegData(compressionQuality: 0.8)!, name: "default widget")
